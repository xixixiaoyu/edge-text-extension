...
`;
	...
	const text =
		'请对提供的内容进行全面整理优化，具体任务包括：将内容分类并重新组织，以形成逻辑清晰有条理的结构；去除赘述内容；改进措辞，确保语言通俗易懂；检查和修正错误，保持内容的准确性；必要时补充相关知识，丰富内容的深度和广度。请直接给出最终优化后的内容，原始内容如下：';
	...
	function fetchData(selectedText) {
		...
		const requestParams = {
			...
			messages: [
				{
					role: 'system',
					content: `回答请仔细遵循以下四项原则：
											1.担当与提问最相关的专家角色，提供最有价值且实用详尽的回答
											2.如果提出的问题你不熟悉或者超出了你的知识范围，请直接说“我不知道”
											3.回答请符合标准文档格式规范，如中文与英文之间需要空格等
											4.回答要通俗易懂，经过彻底的研究和反复的思考，不要赘述，只提供准确可靠的信息`,
				},
